...
const DEFAULT_SETTINGS = {
  ...
  tagArtLogo: "https://raw.githubusercontent.com/twokinp-hue/twokinp-website/main/tag-art-logo.png",
...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-white text-gray-900 font-sans">
      ...
      {/* NOVO: BARRA DINÂMICA TAG ART (Cinemática Restaurada) */}
            ...
            <div className="flex gap-20 animate-marquee items-center">
              {[...Array(10)].map((_, i) => (
                <div key={i} className="flex items-center gap-8">
                  ...
                  <span className="text-white text-xl md:text-3xl font-black italic tracking-tighter uppercase font-sans">Language of the Soul</span>
                </div>
              ))}
            </div>
          </div>
      ...
      {/* DASHBOARD ADMIN INTEGRADO (Firebase Funcional) */}
      {isAdminMode && (
              ...
              <div className="max-w-6xl mx-auto">
                  ...
                  {adminTab === "settings" && (
                    <form onSubmit={async (e) => { e.preventDefault(); await setDoc(doc(db, 'artifacts', appId, 'public', 'data', 'settings', 'config'), siteSettings); alert("Profile Synced!"); }} className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-10 bg-gray-50 p-6 md:p-12 rounded-[2.5rem] border text-black shadow-sm">
                      ...
                      <div className="space-y-2"><label className="text-[10px] font-black uppercase text-gray-400">Tag Art Logo URL</label><input className="w-full p-5 bg-white border rounded-2xl font-bold" value={siteSettings.tagArtLogo} onChange={e => setSiteSettings({...siteSettings, tagArtLogo: e.target.value})} /></div>
...
// TWOKINP V31.0 - CINEMATIC RESTORED & DASHBOARD FIXED